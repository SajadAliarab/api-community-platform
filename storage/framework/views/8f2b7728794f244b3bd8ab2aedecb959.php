...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.section.index','data' => ['collapsible' => true,'collapsed' => true,'icon' => 'heroicon-m-exclamation-triangle','iconColor' => 'danger']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['collapsible' => true,'collapsed' => true,'icon' => 'heroicon-m-exclamation-triangle','icon-color' => 'danger']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['href' => 'https://community.sajad.uk','tag' => 'a','color' => 'warning','icon' => 'heroicon-m-home']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => 'https://community.sajad.uk','tag' => 'a','color' => 'warning','icon' => 'heroicon-m-home']); ?>
            Back Home
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/sajad/CommunityPlatform/api-community-platform/resources/views/filament/pages/auth/login-custom.blade.php ENDPATH**/ ?>